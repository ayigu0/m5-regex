...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        final boolean propertyOne = Pattern.matches("[a-zA-Z0-9]*[a-z][a-zA-Z0-9]*", str);
        final boolean propertyTwo = Pattern.matches("[a-zA-Z0-9]*[A-Z][a-zA-Z0-9]*", str);
        final boolean propertyThree = Pattern.matches("[a-zA-Z0-9]*[0-9][a-zA-Z0-9]*", str);
